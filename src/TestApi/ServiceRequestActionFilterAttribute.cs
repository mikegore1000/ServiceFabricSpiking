...
namespace TestApi
{
    ...
    internal sealed class ServiceRequestActionFilterAttribute : ActionFilterAttribute
    {
        ...
        {
            //ServiceEventSource.Current.ServiceRequestStop(actionExecutedContext.ActionContext.ActionDescriptor.ActionName, actionExecutedContext.Exception?.ToString() ?? string.Empty);
        }
    }
}
